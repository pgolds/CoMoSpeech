...
from text.mix.sequence import text2sequence
from text.mix.symbol import symbol_chinese
from text.normalization.text import TextNormalizer
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        for i, text in enumerate(texts):
            ...
            text = tn.normalize_sentence(text)
            text_norm = text2sequence(text)
            x = torch.LongTensor(text_norm).cuda()[None]
